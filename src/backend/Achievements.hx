...
class Achievements {
	public static function init()
	{
		...
		createAchievement('roadkill_enthusiast',	{name: "Roadkill Enthusiast", description: "Watch the Henchmen die 50 times. Requires Base FNF Content.", maxScore: 50, maxDecimals: 0});

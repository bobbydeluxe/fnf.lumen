...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['riconuts', 'rico', 'made the epic rating graphic [from their fnf troll engine] as well as the hitsound [also from troll engine]', 'https://github.com/riconuts', '3F47CC'],
			['unholywanderer04', 'unholy', 'source of the optimized pico speaker shoot asset', 'https://github.com/Unholywanderer', '5F92E9'],
			[""],
			['P-Slice Engine Team'],

...
class FunkinLua {
	...
	public function new(scriptName:String) {
		...
		set('isLumen', MainMenuState.isLumen);
		...
		Lua_helper.add_callback(lua, "triggerStateEvent", function(eventName:String, eventValue:Dynamic = 1,eventValue2:Dynamic = 1, songStoryMode:Bool = false)) {
			switch (eventName) {
				case "ChangeState" :
